// Generated on 2015-02-05 using generator-chromeapp 0.2.14
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
        ...
        dist: {
            files: {
                '<%= config.app %>/styles/app.css': '<%= config.dev %>/styles/app.scss'
            }
        }
    },
    ...
    jade: {
      compile: {
        files: {
          '<%= config.app %>/index.html': ['<%= config.dev %>/index.jade']
        },
        options: {
          pretty: true,
